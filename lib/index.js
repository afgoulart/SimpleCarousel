...
var Simplecarousel = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "simple-carousel" },
        react_1.default.createElement("div", { ref: function (inst) { return setRefWrapper(inst); }, className: classnames_1.default('simple-carousel-wrapper', props.wrapperClasses) },
            props.list &&
                props.list.length > 0 &&
                props.list.map(function (item, i) {
                    return (react_1.default.createElement("div", { key: "simple-carousel-item-" + item.type + "-" + i, className: classnames_1.default("simple-carousel-item " + item.id, item.itemCustomClass), onClick: function (e) { var _a, _b, _c; return (_c = (_a = item) === null || _a === void 0 ? void 0 : (_b = _a).onClickItem) === null || _c === void 0 ? void 0 : _c.call(_b, e); } }, item.content));
                }),
            props.lastItem),
